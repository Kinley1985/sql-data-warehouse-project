...
Parameters:
  None.
  This stored procedure does not accept any parameters or return only any values
...
*/
		...
		SELECT
			...
			CASE
				...
				ELSE TRIM(cntry)
			END AS cntry -- Normalize and Handle missing or blank country cases
		FROM
			bronze.erp_loc_a101
